...
class Unit : public WorldObject
{
    public:
        ...
        uint32 GetPlayerCritDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_RESILIENCE_CRIT_TAKEN, 0.8f, 33.0f, damage); } // Huh, High Sensivity (100resil = - 10% damage) now fixed
		...
		uint32 GetPlayerDamageReduction(uint32 damage) const { return GetCombatRatingDamageReduction(CR_RESILIENCE_PLAYER_DAMAGE_TAKEN, 0.6f, 100.0f, damage); } // Huh, High Sensivity (100resil = - 10% damage) now fixed
